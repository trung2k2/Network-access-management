        ...
        var e = {
            ...
            790: (t, e, n) => {
                ...
                e.default = function(t) {
                    ...
                    t.API.autoTableSetDefaults = function(t) {
                        return i.DocHandler.setDefaults(t, this),
                        this
                    }
                    ,
                  ...
                  , o = function() {
                    ...
                    t.prototype.applyStyles = function(e, n) {
                        ...
                        e.fontStyle) {
                            ...
                            u && -1 === u.indexOf(a) && (this.jsPDFDocument.setFontStyle && this.jsPDFDocument.setFontStyle(u[0]),
                            a = u[0])
                        }
                        if (this.jsPDFDocument.setFont(s, a),
            ...
            148: (t, e, n) => {
                ...
                function i(t, e, n, i, a, s) {
                    ...
                    if (u.length > 0 && (a || "none" !== p.display))
                        return u
                }
                function l(t) {
                    var e = t.cloneNode(!0);
            ...
            587: (t, e, n) => {
                ...
                e.parseInput = function(t, e) {
                    ...
                    var f = function(t, e, n) {
                      ...
                      , g = function(t, e) {
                        var n, o, r, l, a, s, u, d, h, c, f, p, g, y = (0,
                        i.parseSpacing)(e.margin, 40 / t.scaleFactor()), v = null !== (n = function(t, e) {
                      ...
                      , y = function(t, e, n) {
                        ...
                        if (e.html) {
                            ...
                            if (n) {
                                var u = (0,
                                o.parseHtml)(t, e.html, n, a, e.useCss) || {};
                                r = u.head || r,
                                i = u.body || r,
                                l = u.foot || r
                            } else
                ...
                e.default = function(t, e, o, r) {
                    for (var i = function(e) {
                        ...
                        [["showFoot", "showFooter"], ["showHead", "showHeader"], ["didDrawPage", "addPageContent"], ["didParseCell", "createdCell"], ["headStyles", "headerStyles"]].forEach((function(t) {
                            var n = t[0]
                              , o = t[1];
                            e[o] && (console.error("Use of deprecated option " + o + ". Use " + n + " instead"),
                            e[n] = e[o])
                        }
                        )),
                        [["padding", "cellPadding"], ["lineHeight", "rowHeight"], "fontSize", "overflow"].forEach((function(t) {
                            ...
                            void 0 !== e[n] && (void 0 === e.styles[o] && (e.styles[o] = e[n]),
            ...
            287: (t, e, n) => {
                  ...
                  , l = function() {
                    ...
                    t.prototype.callCellHooks = function(t, e, n, o, i, l) {
                        for (var a = 0, s = e; a < s.length; a++) {
                            var u = !1 === (0,
                            s[a])(new r.CellHookData(t,this,n,o,i,l));
                            if (n.text = Array.isArray(n.text) ? n.text : [n.text],
                            u)
                                return !1
                        }
                        return !0
                ...
                var a = function() {
                    function t(t, e, n, r, i) {
                        ...
                        this.height = 0,
                        this.raw = t,
                        t instanceof o.HtmlRowInput && (this.raw = t._element,
                ...
                var s = function() {
                    ...
                    t.prototype.padding = function(t) {
                        var e = (0,
                        i.parseSpacing)(this.styles.cellPadding, 0);
            ...
            858: (t, e, n) => {
                ...
                function d(t, e, n, o, r, i, s) {
                    ...
                    var h = (0,
                    a.assign)({}, d.table, d[t], r.styles, u)
                        ...
                        var n = t.content
                          , o = function(t) {
                            return t.map((function(t, e) {
                                var n, o, i;
                                return i = "object" == typeof t && null !== (o = null !== (n = t.dataKey) && void 0 !== n ? n : t.key) && void 0 !== o ? o : e,
                                new r.Column(i,t,e)
                            }
                            ))
                        }(n.columns);
            ...
            49: (t, e, n) => {
                ...
                function h(t, e, n, o, r, l, s) {
                    ...
                    if (n.canEntireRowFit(u, s))
                        ...
                        return e.getMaxCellHeight(o.columns) > l ? (u && console.error("The content of row " + e.index + " will not be drawn correctly since drawing rows with a height larger than the page height and has cells with rowspans is not supported."),
                        !0) : !u && "avoid" !== o.settings.rowPageBreak
                    }(t, n, u, e)) {
                        var f = function(t, e, n, o) {
                            ...
                            for (var l = 0, s = 0, u = n.columns; s < u.length; s++) {
                                ...
                                if (m = t.cells[h.index]) {
                                    ...
                                    m.contentHeight >= e && (m.contentHeight = e,
                ...
                function f(t, e, n) {
                    ...
                    "number" == typeof o.lineWidth) {
                        var i = (0,
                        r.getFillStyle)(o.lineWidth, o.fillColor);
                        ...
                        l.map((function(i) {
                            var l = (0,
                            r.getFillStyle)(a[i], o.fillColor);
                ...
                function p(t, e, n, o, i) {
                    void 0 === i && (i = []),
                    t.applyStyles(t.userStyles),
                    "everyPage" === e.settings.showFoot && e.foot.forEach((function(n) {
                        return c(t, e, n, o, i)
                    }
                    )),
                    ...
                    o.y = l.top,
                    n.y = l.top,
                    "everyPage" === e.settings.showHead && e.head.forEach((function(n) {
                        return c(t, e, n, o, i)
                    }
                    ))
                }
                ...
                e.drawTable = function(t, e) {
                    ...
                    ("always" === n.pageBreak || null != n.startY && f > y.pageSize().height) && (g(y),
                    s.y = i.top);
                    var v = (0,
                    a.assign)({}, s);
                    e.startPageNumber = y.pageNumber(),
                    !0 === n.horizontalPageBreak ? function(t, e, n, o) {
                        u.default.calculateAllColumnsCanFitInPage(t, e).map((function(r, i) {
                            t.applyStyles(t.userStyles),
                            i > 0 ? p(t, e, n, o, r.columns) : function(t, e, n, o) {
                                var r = e.settings;
                                t.applyStyles(t.userStyles),
                                ("firstPage" === r.showHead || "everyPage" === r.showHead) && e.head.forEach((function(r) {
                                    return c(t, e, r, n, o)
                                }
                                ))
                            }(t, e, o, r.columns),
                            ...
                            function(t, e, n, o) {
                                var r = e.settings;
                                t.applyStyles(t.userStyles),
                                ("lastPage" === r.showFoot || "everyPage" === r.showFoot) && e.foot.forEach((function(r) {
                                    return c(t, e, r, n, o)
                                }
                                ))
                            }(t, e, o, r.columns)
                    ...
                    }(y, e, v, s) : (y.applyStyles(y.userStyles),
                    "firstPage" !== n.showHead && "everyPage" !== n.showHead || e.head.forEach((function(t) {
                    ...
                    y.applyStyles(y.userStyles),
                    "lastPage" !== n.showFoot && "everyPage" !== n.showFoot || e.foot.forEach((function(t) {
                        return c(y, e, t, s, e.columns)
                    }
                    ))),
                    (0,
            ...
            435: (t, e, n) => {
                ...
                var o = n(200)
                  , r = function(t, e) {
                    var n = (0,
                    o.parseSpacing)(e.settings.margin, 0);
                ...
                e.default = {
                    ...
                    calculateAllColumnsCanFitInPage: function(t, e) {
                        for (var n = [], o = 0, r = e.columns.length; o < r; ) {
                            ...
                            l && l.columns && l.columns.length ? (o = l.lastIndex,
                            n.push(l)) : o++
                        }
                        return n
                    },
            ...
            189: (t, e, n) => {
                ...
                function l(t, e, n, r, i) {
                    return t.map((function(t) {
                        return function(t, e, n, r, i) {
                            ...
                            if ((e = Math.ceil(e * l) / l) >= (0,
                            o.getStringWidth)(t, n, r))
                                return t;
                            for (; e < (0,
                            o.getStringWidth)(t + i, n, r) && !(t.length <= 1); )
                ...
                e.calculateWidths = function(t, e) {
                        ...
                        e.allRows().forEach((function(r) {
                            for (var a = 0, s = e.columns; a < s.length; a++) {
                                ...
                                if (d) {
                                    ...
                                    d.contentWidth = (0,
                                    o.getStringWidth)(d.text, d.styles, t) + c;
                                    var f = (0,
                                    o.getStringWidth)(d.text.join(" ").split(/\s+/), d.styles, t);
                                    if (d.minReadableWidth = f + d.padding("horizontal"),
                                    "number" == typeof d.styles.cellWidth)
                                        ...
                                        d.contentWidth > l ? (d.minWidth = l,
                                        d.wrappedWidth = l) : (d.minWidth = d.contentWidth,
                        ...
                        e.allRows().forEach((function(t) {
                            for (var n = 0, o = e.columns; n < o.length; n++) {
                                ...
                                if (i && 1 === i.colSpan)
                                    ...
                                    a && "number" == typeof a && (r.minWidth = a,
                                    r.wrappedWidth = a)
                                }
                                i && (i.colSpan > 1 && !r.minWidth && (r.minWidth = i.minWidth),
                    ...
                    e.columns.forEach((function(t) {
                        ...
                        o ? t.width = o : (t.width = t.wrappedWidth,
                        n.push(t)),
                        a += t.width
                    }
                    ));
                    ...
                    s = Math.abs(s),
                    !e.settings.horizontalPageBreak && s > .1 / t.scaleFactor() && (s = s < 1 ? s : Math.round(s),
                        ...
                        for (var n = {
                            ...
                            for (var i = r[o], a = 0, s = t.columns; a < s.length; a++) {
                                ...
                                if (d) {
                                    ...
                                    }) : "ellipsize" === d.styles.overflow ? d.text = l(d.text, h, d.styles, e, "...") : "hidden" === d.styles.overflow ? d.text = l(d.text, h, d.styles, e, "") : "function" == typeof d.styles.overflow && (d.text = d.styles.overflow(d.text, h)),
